...
import co.sg.example.weatherforecast.BR
import co.sg.example.weatherforecast.R
import co.sg.example.weatherforecast.models.Forecast

class ForecastAdapter(
    private var items: MutableList<Forecast.ListEntries>,
    private val listener: (Forecast.ListEntries) -> Unit
    ...
    class ViewHolder(private val binding: ViewDataBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(item: Forecast.ListEntries, listener: (Forecast.ListEntries) -> Unit) =
            with(binding.root) {
