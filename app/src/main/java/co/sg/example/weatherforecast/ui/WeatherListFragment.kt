package co.sg.example.weatherforecast.ui
...
import co.sg.example.weatherforecast.R
import co.sg.example.weatherforecast.extensions.setEmptyStateView
import co.sg.example.weatherforecast.extensions.stop
import co.sg.example.weatherforecast.extensions.toast
import co.sg.example.weatherforecast.models.Forecast
import co.sg.example.weatherforecast.networking.Status
import co.sg.example.weatherforecast.viewmodels.ForecastListViewModel
    ...
    override fun onCreateView(
        ...
        if (view.weatherList is RecyclerView) {
            ...
            recyclerView.apply {
                ...
                forecastAdapter = ForecastAdapter(mutableListOf()) { item: Forecast.ListEntries ->
                    itemClicked(item)
                }
